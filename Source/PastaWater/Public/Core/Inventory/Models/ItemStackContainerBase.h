...
#include "ItemStackContainerBase.generated.h"
 ...
 */
UCLASS()
class PASTAWATER_API UItemStackContainerBase : public UObject, public IItemStackContainerInterface
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	static UItemStackContainerBase* Make(const int MaxInventorySize);
};
